...
function ResponsiveInfoCell({ member }) {
  ...
  return (
    ...
    //       variant='h6'
    //       component='div'
    //       color={member.declaration ? 'success' : 'error'}
    //     >
    //       {member.firstName}
    //     </Typography>
    ...
    // >
    //   <Image
    //     src={member.img || '/defaultPhoto.png'}
    ...
    //     <Box
    //       sx={{ display: 'flex', gap: 1, flexDirection: 'row', ml: { md: 1 } }}
    //     >
    //       <span className='text-xs text-gray-600'>{member.firstName}</span>
    //       <span className='text-xs text-gray-500'>{member.middleName}</span>
